...
var Input = {
	...
	selectedAgeGroup: $("#hdnqtype").val(),
	Mode: $("#hdnoffername").val(),
	currentPage: currentPage_lazy
};
$.post("/umbraco/Surface/SpecialOffers/GetSpecialoffersListDetails",
	{
		Input
	},
...
function GetWorkSheetListSpecialOffers(currentPage_lazy) {
	...
	$.ajax({
		...
		//cache: true,
		dataType: "html",
		url: "/umbraco/Surface/SpecialOffers/GetSpecialOffersListDetails",
		data: Input,
