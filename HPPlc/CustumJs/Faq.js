    ...
    $.ajax({
        ...
        success: function (data) {
           // var disabledate = ["1/2/2022", "3/2/2022"];//dates to disable
            ...
            /*var numToAdd = 7 + PublicHolidayList.length;*/
            var numToAdd = 7;

            for (let i = 1; i < numToAdd; i++) {
               // console.log(maxday.getDay());
                if (maxday.getDay() === 6) {
            ...
            $('#SelectDate').datepicker({
                ...
                filter: function (date, view) {
                    ...
                    $thisDate = (date.getDate() < 10 ? '0' : '') + date.getDate() + "-" + (date.getMonth() < 10 ? '0' : '') + (date.getMonth() + 1) + "-" + date.getFullYear();
                    //console.log($thisDate);
                    if ($.inArray($thisDate, PublicHolidayList) != -1 && date.getDay() != 0) {
                        return false;
                    }
                }
            });
