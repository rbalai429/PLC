...
namespace HPPlc.Models.WorkSheet
{
    ...
    public class WorkSheetVideoModel
    {
        public List<WorkSheetVideoItems> WorkSheets
        {
            get; set;
        }
    ...
    public class WorkSheetVideoItems
    {
        public int ItemId
        {
            get; set;
        ...
        public List<dynamic> NestedItems
        {
            get; set;
        }
        public dynamic SeeMore
        {
            get; set;
        }
        public string ViewAll
