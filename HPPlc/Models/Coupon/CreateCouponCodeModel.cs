...
namespace HPPlc.Models.Coupon
{
    public class CreateCouponCodeModel
    {
        ...
        public string CouponCodePrefix
        {
            get; set;
        }
        public int NoOfCouponCode
        {
            get; set;
        }
        ...
        public int IsAppliedForSubscriptionValue
        {
            get; set;
        }
        ...
        public int IsCouponAppliedForAgeGroupValue
        {
            get; set;
        }
        ...
        public int IsAppliedForMultipleUserTypeValue
        {
            get; set;
        }
        ...
        public bool? IsAppliedForDomain
        {
            get; set;
        }
