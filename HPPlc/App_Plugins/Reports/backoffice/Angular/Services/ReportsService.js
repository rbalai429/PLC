...
app.service('Comman', function () {
    ...
    this.GetDownlaodDataExportToExcelAllUmbracoAuthorizedApiUrl = function () {
        return "/umbraco/backoffice/api/ReportsAuthorizeApi/DownloadDataExportToExcelAll";
    }
    ...
    this.GetSendWhatsAppNotificationListUrl = function () {
        return "/umbraco/backoffice/api/ReportsAuthorizeApi/GetAllSendWhatsAppNotificatoinList";
    }
    this.GetSendWhatsAppNotificationExportToExcelUmbracoAuthorizedApiUrl = function () {
        return "/umbraco/backoffice/api/ReportsAuthorizeApi/SendWhatsAppNotificatoinExportToExcel";
    }
    this.GetAgeGroupSynonimsNameForAdvanceSearchExportToExcelUmbracoAuthorizedApiUrl = function () {
        return "/umbraco/backoffice/api/ReportsAuthorizeApi/AgeGroupeAdvancedExportToExcel";
    }
    //End Deepak Changes

    this.DownloadBulkMediaUploadSheetListUrl = function () {
        return "/umbraco/backoffice/api/ReportsAuthorizeApi/ExportBulkMediaSheet";
    }
});
